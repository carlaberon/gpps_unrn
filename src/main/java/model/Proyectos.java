...
public class Proyectos {
    ...
    public void asignarDocenteTutor(int idProyecto, Tutor docente, Tutor tutor) {
        this.gestorDeProyectos.registrarAsignacionDocenteTutor(idProyecto, docente, tutor);
    }
}
